...
//        String [] tableNames = new String[]{"pro_sta_score"};
        ...
        String [] modules = new String[]{"device_pojo", "device_mapper", "device_service", "device_controller"};//项目模块名，需自定义
...
//        String templatePath = "/templates/mapper.xml.ftl";
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return new File("device_mapper").getAbsolutePath()+ "/src/main/resources/mapper/" + tableInfo.getEntityName()
    ...
    private static TemplateConfig getTemplateConfig(String module) {
        ...
        if ("device_pojo".equals(module)){
            templateConfig.setEntity(new TemplateConfig().getEntity(false))
        ...
        } else if ("device_mapper".equals(module)){
                    ...
                    .setServiceImpl(null)
                    .setController(null);
        } else if ("device_service".equals(module)){
            templateConfig.setEntity(null)
                    .setMapper(null)
                    .setXml(null)
                    ...
                    .setController(null);
        } else if ("device_controller".equals(module)){//web模块只生成controller代码
            templateConfig.setEntity(null)
                    .setMapper(null)
                    .setXml(null)
                    .setService(null)
    ...
    private static StrategyConfig getStrategyConfig(String[] tableNames) {
        ...
        strategyConfig
                ...
                .setSuperEntityClass("com.jhc.DO.BaseDo") //继承父类实体类
                .setSuperEntityColumns(new String[]{"id","create_time", "update_time","create_user", "update_user", "is_del"})
    ...
    private static PackageConfig getPackageConfig(String module) {
        ...
        String packageName = "com.jhc";//不同模块 代码生成具体路径自定义指定
...
//                .setXml("mapper")
    ...
    private static DataSourceConfig getDataSourceConfig() {
        String dbUrl = "jdbc:mysql://121.36.222.157:3306/device_backend?useSSL=false&serverTimezone=GMT%2B8&characterEncoding=utf8&allowPublicKeyRetrieval=true";
        DataSourceConfig dataSourceConfig = new DataSourceConfig();
        dataSourceConfig.setDbType(DbType.MYSQL)
                .setDriverName(Driver.class.getName())
                .setUsername("root")
                .setPassword("Jhc103Mysql")
                .setUrl(dbUrl);
